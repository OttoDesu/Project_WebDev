...
<div class="layout-shell">
    ...
    <section class="main-panel">
        ...
        <div class="grid">
            <div class="card">
                <h3>Job Listings</h3>
                <p class="muted">Create, edit, or remove openings.</p>
                <a class="button" href="<?php echo h(url_for('admin/jobs.php')); ?>">Manage Jobs</a>
            </div>
            <div class="card">
                <h3>Applications</h3>
                <p class="muted">Review applicants and update statuses.</p>
                <a class="button" href="<?php echo h(url_for('admin/applications.php')); ?>">View Applications</a>
            </div>
        </div>
    </section>
</div>
